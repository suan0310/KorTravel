...
$(function() {
	$(document).ready(function() {
		...
		var coords = new daum.maps.LatLng(mapY, mapX);
	...
	$("#nextBtn").on("click", function() {
		document.getElementById("facilityDetailData").className = "facilityDetailData slide-event-1";
		document.getElementById("facilityDetailData2").className = "facilityDetailData slide-event-2 overviewArea";
	});
	
	// 이전단계 버튼 클릭시
	$("#prevBtn").on("click", function() {
		document.getElementById("facilityDetailData").className = "facilityDetailData slide-event-3";
		document.getElementById("facilityDetailData2").className = "facilityDetailData slide-event-4 overviewArea";
	});

	// 추천업소 등록하기 버튼 클릭시
	$("#detailRecommand").on("click", function() {
...
//			document.getElementById("recommandArea-2").className = "facilityDataInputArea";
	...
	$("#detailBtn").on("click", function() {
		...
		document.getElementById("facilityRegForm").action = "/admin/facilityDetail?overview=" + overview;
